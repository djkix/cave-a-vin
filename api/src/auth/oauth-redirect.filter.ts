...
/**
 * Le retour Google est une navigation, pas un appel XHR : une adresse hors liste
 * blanche doit ramener l'utilisateur sur l'écran de connexion avec un message en
 * français, pas afficher un JSON 403 brut dans le navigateur.
 */
